...
Feature: Validating pizza application functionalities
  ...
  Scenario Outline: Validating place order functionality
    ...
    Examples:
      ...
      | Small 6 Slices - no toppings | Mushrooms | Extra cheese | 1        | Patel Harsh | patel@gmail.com | 1234567858 | Credit Card    |
      | Large 10 Slices - 2 toppings | Mushrooms | Extra cheese | 2        | John Doe    | john@gmail.com  | 1234565858 | Cash on Pickup |
      | Medium 8 Slices - 2 toppings | Olives    | Salami       | 3        | Kim Moore   | kim@gmail.com   | 1234567158 | Credit Card    |