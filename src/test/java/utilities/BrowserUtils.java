...
public class BrowserUtils {
    ...
    public static void selectDropdownByText(WebElement element, String value) {
         ...
         * that is provided within the parameter.
        ...
        public static String takeScreenShot () throws IOException {
            ...
            String path = "/Users/zarina/MindtekTestNGFramework/src/test/resources/configurations/screenshots/" + screenshotName;
         ...
         * @return
         */
        public static WebElement waitElementToClickable (WebElement element){
